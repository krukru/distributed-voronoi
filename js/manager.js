...
function taskCompleted(event) {
	...
	$.post("paint.php", {data : encodedResponse })
		.done(function(data) {
			...
			document.getElementById("result").innerHTML = "<a href='diagram.php' target='_blank'>Link to the results</a><br><br><button class='btn-blue' onclick='requestTask();'>Hey that was super fast, let's try again!</button>";
		});
}
